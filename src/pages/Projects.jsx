...
function Projects() {
  return (
    ...
    <div className="mt-5 flex flex-col gap-3 text-slate-500" >
      <p>
      Additionally, I ventured into the realm of 3D websites, 
      as exemplified by my own portfolio. Despite being new to this
       aspect, my portfolio serves as a testament to my commitment to 
       exploring innovative options within the front-end domain.
      </p>
    </div>
